...
//Code Here
let myStrongest = monstersInYourPocket.filter((elem, i, arr ) => elem.CP > 200);
...
let bobs = purchases.filter((elem) => elem.owner === "Bob");
let bobsTotal = bobs.reduce((acc, curr) => acc + curr.price, 0)
